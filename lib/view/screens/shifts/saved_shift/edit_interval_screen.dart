...
class EditIntervalScreen extends StatefulWidget {
  final IntervalModel? interval;
  EditIntervalScreen({@required this.interval});

  @override
  State<EditIntervalScreen> createState() => _EditIntervalScreenState();
}

class _EditIntervalScreenState extends State<EditIntervalScreen> {
      ...
      Consumer<SavedShiftProvider>(
          builder: (context, shiftProvider, child) {
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                title: const Text('Modifica intervallo',
                    style:
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: (){
                            ...
                            shiftProvider.storeShiftIntervalInfo(context, widget.interval!.shiftId!,
                                IntervalModel(
                              ...
                              shiftProvider.getIntervalsList(context, widget.interval!.shiftId!, false);
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                                                    ...
                                                    child: CustomButton(btnTxt: 'Confermare',
                                                      onTap: () {
                                                        if(_titleController!.text.isEmpty){
                                                          ...
                                                          Navigator.pop(context);
                                                          shiftProvider.setIntervalTitle(_titleController!.text);
                                                        }
                                                      },
                                                    ),
                                                  )
                                                ...
                                                children: <Widget>[
                                                  for(int i = 0; i < _iconsList.length ; i++)
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        onTap: () {
                                                          shiftProvider.setIcon(_iconsList[i]);
                                                        },
                                                        child: Container(
                                                            height: 80,
                                                            width: 80,
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: BlockPicker(
                                                              ...
                                                              onColorChanged: (Color color){ //on color picked
                                                                shiftProvider.setIconColor(color);
                                                              },
                            ...
                            shiftProvider.serviceTimesVisible?
                            ServiceTimesWidget(interval: widget.interval): const SizedBox(),
                            ...
                            shiftProvider.breaksVisible?
                            BreakTimesWidget(interval: widget.interval): const SizedBox(),
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>
                                    PlannedExtraordinaryScreen(interval: widget.interval)));
                              },
                              child: const Row(
                                children: [
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>
                                    VoucherScreen(interval: widget.interval)));
                              },
                              child: const Row(
                                children: [
