...
class NewVoucherWidget extends StatelessWidget {
  final IntervalModel? interval;
  final bool fromEmployee;
  NewVoucherWidget({this.interval, this.fromEmployee = false});
    ...
    return
      Consumer<ShiftsProvider>(
          builder: (context, shiftProvider, child) {
            ...
            List<VoucherModel> _vouchers = shiftProvider.vouchers;

            if(fromEmployee == true){
              _vouchers = interval!.vouchers!;
            }else{
              _vouchers = shiftProvider.vouchers;
            }
            return Column(
              children: [
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: CustomButton(btnTxt: 'SÌ',
                                                  onTap: (){
                                                    Navigator.pop(context);
                                                    shiftProvider.removeVoucher(_voucher.id!);
                                                  }),
                                            ),
                                            const SizedBox(width: 14),
                                          ],
                                ...
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text('${_voucher.name != null? _voucher.name : fromEmployee == false? 'Aggiungu+' : ''}',
                                          style:
