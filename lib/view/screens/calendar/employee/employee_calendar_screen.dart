...
import 'package:turnarix/view/screens/calendar/employee/employee_calendar_bottom_sheet.dart';
...
class EmployeeCalendarScreen extends StatefulWidget {
  ...
  EmployeeCalendarScreen({@required this.employeeId});
  @override
  _EmployeeCalendarScreenState createState() =>
      _EmployeeCalendarScreenState();
}

class _EmployeeCalendarScreenState
    extends State<EmployeeCalendarScreen> {
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 1), () {
      Provider.of<WorkerCalendarProvider>(context, listen: false).getShiftIntervals(context, widget.employeeId!);
      Provider.of<WorkerCalendarProvider>(context, listen: false).getCalendarShifts(context, widget.employeeId!);
    });
  ...
  Widget build(BuildContext context) {
    return Consumer<WorkerCalendarProvider>(
                                          ...
                                          return InkWell(
                                            onTap: () async {
                                              ...
                                              showModalBottomSheet(
                                                ...
                                                builder: (con) {
                                                  return EmployeeCalendarBottomSheet(shifts: _dayInfo.calendarShifts, date: _currentDayDate, employeeId: widget.employeeId);
                                                },
                                              );
                                              // showDialog(
                                              //       context: context,
                                              //       builder: (BuildContext context) {
                                              //         return DynamicHeightDialog(shifts: _dayInfo.calendarShifts,
